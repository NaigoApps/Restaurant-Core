...
public class InvoiceBuilderTest {
    ...
    public void testTable() {
        ...
        Invoice result = builder.table(table).getContent();
    ...
    public void testOrder() {
        ...
        Invoice bill = builder.order(order).getContent();
    ...
    public void testOrders() {
        ...
        Invoice bill = builder.orders(Arrays.asList(order1)).getContent();
    ...
    public void testTime(){
        ...
        Invoice bill = builder.printTime(now).getContent();
